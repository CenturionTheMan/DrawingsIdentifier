...
using ToyNeuralNetwork.NeuralNetwork;
...
namespace DrawingIdentifierGui
{
    ...
    public partial class App : Application
    {
        ...
        public static (ToyNeuralNetwork.Math.Matrix[] inputs, ToyNeuralNetwork.Math.Matrix outputs)[] TrainData { get; set; } = Array.Empty<(ToyNeuralNetwork.Math.Matrix[] inputs, ToyNeuralNetwork.Math.Matrix outputs)>();
        public static (ToyNeuralNetwork.Math.Matrix[] inputs, ToyNeuralNetwork.Math.Matrix outputs)[] TestData { get; set; } = Array.Empty<(ToyNeuralNetwork.Math.Matrix[] inputs, ToyNeuralNetwork.Math.Matrix outputs)>();

        public static (ToyNeuralNetwork.Math.Matrix[] inputs, ToyNeuralNetwork.Math.Matrix outputs)[] TrainDataFlat { get; set; } = Array.Empty<(ToyNeuralNetwork.Math.Matrix[] inputs, ToyNeuralNetwork.Math.Matrix outputs)>();
        public static (ToyNeuralNetwork.Math.Matrix[] inputs, ToyNeuralNetwork.Math.Matrix outputs)[] TestDataFlat { get; set; } = Array.Empty<(ToyNeuralNetwork.Math.Matrix[] inputs, ToyNeuralNetwork.Math.Matrix outputs)>();
